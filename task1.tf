...
connection {
    type     = "ssh"
    user     = "ec2-user"
    private_key = file("C:/Users/dsb89/Downloads/key1111.pem")
...
resource "aws_ebs_volume" "serverVolume" {
 ...
 provisioner "remote-exec" {
    inline = [
      ...
      "sudo git clone https://github.com/Devendra-97/hybridcloud.git  /var/www/html/"
    ]
  }
}
...
resource "aws_s3_bucket_object" "object_upload" {
  ...
  key    = "name.jpg"
  source = "C:/Users/dsb89/Desktop/name.jpg"
